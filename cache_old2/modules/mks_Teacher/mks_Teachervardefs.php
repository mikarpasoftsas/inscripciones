<?php 
 $GLOBALS["dictionary"]["mks_Teacher"]=array (
  'table' => 'mks_teacher',
  'audited' => true,
  'inline_edit' => true,
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'mks_teacher_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'mks_teacher_modified_user',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'mks_teacher_assigned_user',
    ...
    array (
      'name' => 'SecurityGroups',
      'type' => 'link',
      'relationship' => 'securitygroups_mks_teacher',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'mks_teacher_email_addresses_primary',
      'source' => 'non-db',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'mks_teacher_email_addresses',
      'source' => 'non-db',
    ...
    array (
      ...
      'precision' => 6,
      'id' => 'mks_Teacheramount_theory_c',
      'custom_module' => 'mks_Teacher',
    ),
    'currency_id' => 
    array (
      'inline_edit' => 1,
      ...
      'id' => 'mks_Teachercurrency_id',
      'custom_module' => 'mks_Teacher',
    ),
    'amount_practice_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Monto Practica',
      'required' => false,
      'source' => 'custom_fields',
      ...
      'enable_range_search' => false,
      'precision' => 6,
      'id' => 'mks_Teacheramount_practice_c',
      'custom_module' => 'mks_Teacher',
    ),
