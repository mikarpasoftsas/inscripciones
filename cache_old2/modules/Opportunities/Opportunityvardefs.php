 ...
 $GLOBALS["dictionary"]["Opportunity"]=array (
  ...
  array (
    ...
    array (
      ...
      'format' => '{PI}{-}{y}{-}{00000}{}{}',
      'start_number' => '00001',
      'id' => 'Opportunitiesid_autoincrement_c',
      'custom_module' => 'Opportunities',
    ),
    ...
    array (
      ...
      'vname' => 'LBL_MEANS_NOTICE_MKS_MEANSNOTICE_ID',
      'type' => 'id',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => '36',
      'size' => '20',
      'id' => 'Opportunitiesmks_meansnotice_id_c',
      'custom_module' => 'Opportunities',
    ),
    'means_notice_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Medio de aviso 1',
      'required' => true,
      'source' => 'non-db',
      'name' => 'means_notice_c',
      'vname' => 'LBL_MEANS_NOTICE',
      'type' => 'relate',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'quicksearch' => 'enabled',
      'studio' => 'visible',
      'id' => 'Opportunitiesmeans_notice_c',
      'custom_module' => 'Opportunities',
    ),
    'next_call_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Próxima llamada',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'next_call_c',
      'vname' => 'LBL_NEXT_CALL',
    ...
    array (
      ...
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'origin_conact_c',
      'vname' => 'LBL_ORIGIN_CONACT_C',
      'type' => 'multienum',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'merge_filter' => 'disabled',
      'size' => '20',
      'options' => 'origin_conact_list',
      'studio' => 'visible',
      'isMultiSelect' => true,
      'id' => 'Opportunitiesorigin_conact_c',
      'custom_module' => 'Opportunities',
    ),
    'mks_meansnotice_id1_c' => 
    array (
      'inline_edit' => 1,
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'mks_meansnotice_id1_c',
      'vname' => 'LBL_MEANS_NOTICE1_MKS_MEANSNOTICE_ID',
      'type' => 'id',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => '36',
      'size' => '20',
      'id' => 'Opportunitiesmks_meansnotice_id1_c',
      'custom_module' => 'Opportunities',
    ),
    'means_notice1_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Medio de Aviso 2',
      'required' => false,
      'source' => 'non-db',
      'name' => 'means_notice1_c',
      'vname' => 'LBL_MEANS_NOTICE1',
      'type' => 'relate',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id_name' => 'mks_meansnotice_id1_c',
      'ext2' => 'mks_MeansNotice',
      'module' => 'mks_MeansNotice',
      'rname' => 'name',
      'quicksearch' => 'enabled',
      'studio' => 'visible',
      'id' => 'Opportunitiesmeans_notice1_c',
      'custom_module' => 'Opportunities',
    ),
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'origin fb c',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'origin_fb_c',
      'vname' => 'LBL_ORIGIN_FB_C',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => '0',
      'no_default' => false,
      'comments' => 'El registro se origina por el webhook de fb',
      'help' => '',
      'importable' => 'true',
      'duplicate_merge' => 'disabled',
      'duplicate_merge_dom_value' => '0',
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Opportunitiesorigin_fb_c',
      'custom_module' => 'Opportunities',
    ),
    'courses_of_interest_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Cursos de Interes',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'courses_of_interest_c',
      'vname' => 'LBL_COURSES_OF_INTEREST',
      'type' => 'text',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'rows' => '4',
      'cols' => '20',
      'id' => 'Opportunitiescourses_of_interest_c',
      'custom_module' => 'Opportunities',
    ),
    'ads_id_c' => 
    array (
