<?php 
 $GLOBALS["dictionary"]["Account"]=array (
  ...
  array (
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'phone alter c',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'phone_alter_c',
      'vname' => 'LBL_PHONE_ALTER_C',
      'type' => 'phone',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
    ...
    array (
      ...
      'studio' => 'visible',
      'dependency' => NULL,
      'id' => 'Accountsid_type_c',
      'custom_module' => 'Accounts',
    ),
    'id_local_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'id local c',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'id_local_c',
      'vname' => 'LBL_ID_LOCAL_C',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
    ...
    array (
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Accountsprimary_address_number_c',
      'custom_module' => 'Accounts',
    ),
    ...
    array (
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Accountsprimary_address_floor_c',
      'custom_module' => 'Accounts',
    ),
    ...
    array (
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Accountsprimary_address_neighborhood_c',
      'custom_module' => 'Accounts',
    ),
    ...
    array (
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Accountsprimary_address_location_c',
      'custom_module' => 'Accounts',
    ),
    ...
    array (
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Accountsprimary_addres_between_stree_c',
      'custom_module' => 'Accounts',
    ),
    ...
    array (
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Accountsprimary_address_home_c',
      'custom_module' => 'Accounts',
    ),
    'first_name_c' => 
    array (
    ...
    array (
      ...
      'size' => '20',
      'dbType' => 'varchar',
      'id' => 'Accountsphone_home_c',
      'custom_module' => 'Accounts',
    ),
    'birthdate_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Fecha de nacimieto',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'birthdate_c',
      'vname' => 'LBL_BIRTHDATE',
    ...
    array (
      ...
      'len' => '36',
      'size' => '20',
      'id' => 'Accountsmks_meansnotice_id_c',
      'custom_module' => 'Accounts',
    ),
    'means_notice_c' => 
    array (
    ...
    array (
      ...
      'id' => 'Accountsid_autoincrement_c',
      'custom_module' => 'Accounts',
    ),
    'fb_user_id_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Id Usuario FB',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'fb_user_id_c',
      'vname' => 'LBL_FB_USER_ID',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Avatar Fbk',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'profile_pic_fbk_c',
      'vname' => 'LBL_PROFILE_PIC_FBK',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Accountsprofile_pic_fbk_c',
      'custom_module' => 'Accounts',
    ),
    'origin_fb_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Origen FB',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'origin_fb_c',
      'vname' => 'LBL_ORIGIN_FB',
      ...
      'default' => '0',
      'no_default' => false,
      'comments' => 'Se origino desde el webhook de FB',
      'help' => '',
      'importable' => 'true',
      'duplicate_merge' => 'disabled',
      'duplicate_merge_dom_value' => '0',
