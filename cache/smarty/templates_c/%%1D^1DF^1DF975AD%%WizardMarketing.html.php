<?php /* Smarty version 2.6.31, created on 2018-09-19 20:08:48
         compiled from modules/Campaigns/WizardMarketing.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', 'modules/Campaigns/WizardMarketing.html', 462, false),array('modifier', 'default', 'modules/Campaigns/WizardMarketing.html', 951, false),array('function', 'sugar_getjspath', 'modules/Campaigns/WizardMarketing.html', 920, false),array('function', 'sugar_getscript', 'modules/Campaigns/WizardMarketing.html', 1493, false),)), $this); ?>
<!--
/*********************************************************************************
		...
		<div id="templateManager" class="template-panel">
			<div id="templateManagerDialog">
				...
				<div id="emailTrackerDialog" class="hidden">
					<h2 class="header-2"><?php echo $this->_tpl_vars['MOD']['LBL_TRACKER_TITLE']; ?>
</h2>
					<div class="clear"></div>
...
">
			...
			<div class="template-panel-container panel">
				<div class="template-container-full ">
					<h4 class="header-4" style="border-bottom: solid 1px #eee;"><?php echo $this->_tpl_vars['MOD']['LBL_TEMPLATE']; ?>
</h4>
					<div class="clear">&nbsp;</div>
...
" onclick="EmailTemplateController('create')" class="">
			...
			<div class="template-panel-container panel-toolbar ">
				<div class="template-container">
					<h2 class="header-2"><?php echo $this->_tpl_vars['MOD']['LBL_TRACKED_URLS']; ?>
</h2>
					<div class="clear"></div>
...
')">
				...
				<div class="template-container">
					<h2 class="header-2"><?php echo $this->_tpl_vars['MOD']['LBL_EMAIL_VARIABLES']; ?>
</h2>
					<div class="clear"></div>
...
<?php echo '\',
						...
						<div class="panel-toolbar">
							<div class="template-container-full">
								<h2 class="header-2"><?php echo $this->_tpl_vars['MOD']['LBL_SUBJECT']; ?>
</h2>
								<div class="form-group clear-block">
...
" class="form-control input-sm"  maxlength="255" size="100" onclick="onClickTemplateSubject(this);">
						...
						<?php if (! $this->_tpl_vars['hide_width_set']): ?>
						<div class="panel-toolbar">
							<div class="template-container">
								<h2 class="header-2"><?php echo $this->_tpl_vars['MOD']['LBL_WIDTH']; ?>
</h2>
								<input type="number" class="form-control input-sm" id="mozaik_width_set" onkeyup="mozaik.setWidth(parseInt(this.value)+'px');" onmouseup="mozaik.setWidth(parseInt(this.value)+'px'); "value="<?php echo $this->_tpl_vars['template_width']; ?>
" >
							</div>
						</div>
						<?php endif; ?>
						...
						<div class="panel-toolbar">
							...
							<div class="template-container-full">
								...
								<br>
								<?php endif; ?>
								<?php echo $this->_tpl_vars['BODY_EDITOR']; ?>
	...
	<div id="step2" class="step2" style="display: none;">
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" class='edit view'>
			...
			<tr>
				<td colspan="4">
					<h4 class="header-4"><?php echo $this->_tpl_vars['MOD']['LBL_MRKT_NAME']; ?>
</h4>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td scope="col" NOWRAP valign="top"><span><?php echo $this->_tpl_vars['MOD']['LBL_MRKT_NAME_FIELD']; ?>
 <span class="required"><?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
</span></span></td>
				<td ><span><input id='marketing_name' name='wiz_step3_name' title='<?php echo $this->_tpl_vars['MOD']['LBL_MRKT_NAME']; ?>
...
"></span></td>
			...
			<tr>
				<td scope="col" NOWRAP valign="top"><span><?php echo $this->_tpl_vars['MOD']['LBL_FROM_MAILBOX_NAME']; ?>
<span class="required"><?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
</span></span></td>
				<td>
					<span>
...
','','','dialogHelpPopup')" src="index.php?entryPoint=getImage&amp;themeName=SuiteR&amp;imageName=helpInline.gif">
				...
				<td style="display: none;" scope="col" NOWRAP valign="top"><span><?php echo $this->_tpl_vars['MOD']['LBL_STATUS_TEXT']; ?>
 <span class="required"><?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
</span></span></td>
				<td style="display: none;"><span><select tabindex='2' id='status' title='<?php echo $this->_tpl_vars['MOD']['LBL_STATUS_TEXT']; ?>
' name='wiz_step3_status'><?php echo $this->_tpl_vars['STATUS_OPTIONS']; ?>
			...
			<tr>
				<td scope="col" NOWRAP valign="top"><span><?php echo $this->_tpl_vars['MOD']['LBL_OUTBOUND_MAILBOX_NAME']; ?>
</span></td>
				<td>
					<span>
...
','','','dialogHelpPopup')" src="index.php?entryPoint=getImage&amp;themeName=SuiteR&amp;imageName=helpInline.gif">
			...
			<tr>
				...
				<td scope="col" NOWRAP valign="top"><span><?php echo $this->_tpl_vars['MOD']['LBL_START_DATE_TIME']; ?>
 <span class="required"><?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
</span></span></td>
				<td  style="display:none;" class="datafield"><span><table  cellpadding="0" cellspacing="0"><tr><td nowrap><input title ='<?php echo $this->_tpl_vars['MOD']['LBL_START_DATE_TIME']; ?>
...
"> <span class="suitepicon suitepicon-module-calendar" alt="<?php echo $this->_tpl_vars['CALENDAR_DATEFORMAT']; ?>
					...
					<table border="0" cellpadding="0" cellspacing="0" class="dateTime">
						<tr valign="middle">
							<td nowrap class="datafield" style="width:150px;">
								<input type="hidden" id="userTimeFormat" value="<?php echo $this->_tpl_vars['TIME_FORMAT']; ?>
">
...
_trigger" class="btn btn-danger" onclick="return false;" title="<?php echo $this->_tpl_vars['APP']['LBL_ENTER_DATE']; ?>
...
"><br>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" class='edit view'>
			...
			<tr style="display: none;">
				<td scope="col" NOWRAP valign="top"><span><?php echo $this->_tpl_vars['MOD']['LBL_MESSAGE_FOR']; ?>
 <span class="required"><?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
</span></span></td>
				<td class="datafield"><span><input type="checkbox"  tabindex='1' onclick="toggle_message_for(this);" id="all_prospect_lists" <?php echo $this->_tpl_vars['ALL_PROSPECT_LISTS_CHECKED']; ?>
...
"><?php echo $this->_tpl_vars['MOD']['LBL_ALL_PROSPECT_LISTS']; ?>
			...
			<tr style="display: none;">
				...
				<td width="35%" class="datafield"><span><select <?php echo $this->_tpl_vars['MESSAGE_FOR_DISABLED']; ?>
...
;
		var oe_stored_options = <?php echo $this->_tpl_vars['OEStoredOptions']; ?>
;
		<?php echo '
...
"});
	...
	<div id='step3' data="summary-page" class="template-panel step3">
		<div class="template-panel-container panel">
			<div class="template-container-full">
				<h4 class="header-4" style="border-bottom: solid 1px #eee;padding-bottom: 8px"><?php echo $this->_tpl_vars['MOD']['LBL_SUMMARY']; ?>
</h4>
				<div class="clear">&nbsp;</div>
...
<?php echo '\';
		...
		<div class="template-panel-container panel-toolbar ">
			<div class="template-container-full">
				<h4 class="header-4" style="border-bottom: solid 1px #eee;padding-bottom: 8px"><?php echo $this->_tpl_vars['MOD']['LBL_CAMPAIGN_CHECKLIST']; ?>
</h4>
				<div class="clear">&nbsp;</div>
				<div style="margin-bottom: 16px;">
					<?php if ($this->_tpl_vars['WARNING_MESSAGE']): ?>
					<div id='target_message' class="target_messege"><font color='red'><b><?php echo $this->_tpl_vars['WARNING_MESSAGE']; ?>
</b></font></div>
					<br class="emptyRow">
					<?php endif; ?>
...
<br><?php endif; ?>
				...
				<ul>
					<li class="li-tick"><span class="suitepicon suitepicon-action-confirm"></span><a href="<?php echo $this->_tpl_vars['link_to_campaign_header']; ?>
"><?php echo $this->_tpl_vars['MOD']['LBL_CAMPAIGN_DETAILS_AND_CONDITIONS']; ?>
</a></li>
					<li class="li-tick"><?php if ($this->_tpl_vars['error_on_target_list']): ?><span class="suitepicon suitepicon-action-clear"></span> <?php else: ?><span class="suitepicon suitepicon-action-confirm"></span><?php endif; ?><a href="<?php echo $this->_tpl_vars['link_to_target_list']; ?>
"><?php echo $this->_tpl_vars['MOD']['LBL_CHOOSE_TARGETS']; ?>
</a></li>
					<?php if ($this->_tpl_vars['campaign_type'] == 'NewsLetter' || $this->_tpl_vars['campaign_type'] == 'Email'): ?>
					<li class="li-tick"><?php if ($this->_tpl_vars['error_on_templates']): ?><span class="suitepicon suitepicon-action-clear"></span> <?php else: ?><span class="suitepicon suitepicon-action-confirm"></span><?php endif; ?><a href="<?php echo $this->_tpl_vars['link_to_choose_template']; ?>
"><?php echo $this->_tpl_vars['MOD']['LBL_CHOOSE_TEMPLATES']; ?>
</a></li>
					<li class="li-tick"><?php if ($this->_tpl_vars['error_on_marketing']): ?><span class="suitepicon suitepicon-action-clear"></span> <?php else: ?><span class="suitepicon suitepicon-action-confirm"></span><?php endif; ?><a id="marketing_status_lnk" href="<?php echo $this->_tpl_vars['link_to_sender_details']; ?>
"><?php echo $this->_tpl_vars['MOD']['LBL_SENDER_DETAILS']; ?>
</a></li>
					<li class="li-tick"><?php if ($this->_tpl_vars['error_on_scheduler2'] || $this->_tpl_vars['error_on_mailbox2']): ?><span class="suitepicon suitepicon-action-clear"></span> <?php else: ?><span class="suitepicon suitepicon-action-confirm"></span><?php endif; ?><a href="<?php echo $this->_tpl_vars['link_to_scheduler']; ?>
...
<?php endif; ?>"><?php echo $this->_tpl_vars['MOD']['LBL_PROCESS_CAMPAIGN_EMAILS']; ?>
					...
					<li class="li-tick"><?php if ($this->_tpl_vars['error_on_scheduler1'] || $this->_tpl_vars['error_on_mailbox1']): ?><span class="suitepicon suitepicon-action-clear"></span> <?php else: ?><span class="suitepicon suitepicon-action-confirm"></span><?php endif; ?><a href="<?php echo $this->_tpl_vars['link_to_scheduler']; ?>
<?php if (! $this->_tpl_vars['link_to_scheduler']): ?><?php echo $this->_tpl_vars['link_to_email']; ?>
...
', $('#marketing_select').val());"<?php endif; ?>>
						<span class="suitepicon suitepicon-action-schedule"></span> <?php echo $this->_tpl_vars['MOD']['LBL_SEND_EMAIL']; ?>
...
', $('#marketing_select').val());"<?php endif; ?>>
					<span class="suitepicon suitepicon-module-emails"></span> <?php echo $this->_tpl_vars['MOD']['LBL_SEND_AS_TEST']; ?>
