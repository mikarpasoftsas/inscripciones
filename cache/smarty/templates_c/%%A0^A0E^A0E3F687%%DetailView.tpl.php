<?php /* Smarty version 2.6.31, created on 2018-09-24 21:42:11
         compiled from cache/themes/SuiteP/modules/Users/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/themes/SuiteP/modules/Users/DetailView.tpl', 41, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Users/DetailView.tpl', 61, false),array('function', 'counter', 'cache/themes/SuiteP/modules/Users/DetailView.tpl', 138, false),array('function', 'sugar_phone', 'cache/themes/SuiteP/modules/Users/DetailView.tpl', 877, false),array('function', 'sugar_getjspath', 'cache/themes/SuiteP/modules/Users/DetailView.tpl', 1433, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/Users/DetailView.tpl', 131, false),array('modifier', 'escape', 'cache/themes/SuiteP/modules/Users/DetailView.tpl', 1402, false),array('modifier', 'url2html', 'cache/themes/SuiteP/modules/Users/DetailView.tpl', 1402, false),array('modifier', 'nl2br', 'cache/themes/SuiteP/modules/Users/DetailView.tpl', 1402, false),)), $this); ?>
...
<div class="buttons">
<input title="Editar" accessKey="E" name="Edit" id="edit_button" value="Editar" onclick="var _form = document.getElementById('formDetailView');_form.return_module.value='Users'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
...
<input id="delete_button" type="button" class="button" onclick="confirmDelete();" value="Eliminar" //>
<input title="Restablecer Preferencias de Usuario" class="button" LANGUAGE="javascript" onclick="if(confirm('¿Está seguro de que desea restablecer todas las preferencias de este usuario?')) window.location='index.php?module=Users&action=resetPreferences&reset_preferences=true&record=<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
';" type="button" name="password" value="Restablecer Preferencias de Usuario"/>
<input title="Restablecer Página de Inicio" class="button" LANGUAGE="javascript" onclick="if(confirm('¿Está seguro de que desea reiniciar su Página de Inicio?')) window.location='index.php?module=Users&action=DetailView&reset_homepage=true&record=<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
';" type="button" name="password" value="Restablecer Página de Inicio"/>
...
<li role="presentation">
<a data-toggle="tab" id="tab0" href="#">Avanzado</a>
</li>
<?php if ($this->_tpl_vars['SHOW_ROLES'] == true): ?>
<li role="presentation">
<a data-toggle="tab" id="tab0" href="#">Acceso</a>
</li>
<?php endif; ?>
</ul>
</li>
...
<a data-toggle="tab" id="tab1" href="#">Avanzado</a>
</li>
<?php if ($this->_tpl_vars['SHOW_ROLES']): ?>
<li role="presentation" class="hidden-xs ">
<a data-toggle="tab" id="tab2" href="#">Acceso</a>
</li>
<?php endif; ?>
<?php if ($this->_tpl_vars['config']['enable_action_menu']): ?>
...
<li><input title="Editar" accessKey="E" name="Edit" id="edit_button" value="Editar" onclick="var _form = document.getElementById('formDetailView');_form.return_module.value='Users'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
...
<li><input id="delete_button" type="button" class="button" onclick="confirmDelete();" value="Eliminar" //></li>
<li><input title="Restablecer Preferencias de Usuario" class="button" LANGUAGE="javascript" onclick="if(confirm('¿Está seguro de que desea restablecer todas las preferencias de este usuario?')) window.location='index.php?module=Users&action=resetPreferences&reset_preferences=true&record=<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
';" type="button" name="password" value="Restablecer Preferencias de Usuario"/></li>
<li><input title="Restablecer Página de Inicio" class="button" LANGUAGE="javascript" onclick="if(confirm('¿Está seguro de que desea reiniciar su Página de Inicio?')) window.location='index.php?module=Users&action=DetailView&reset_homepage=true&record=<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
';" type="button" name="password" value="Restablecer Página de Inicio"/></li>
