...
{capture name="label" assign="label"}{sugar_translate label='LBL_ID_AUTOINCREMENT_C' module='Opportunities'}{/capture}
...
{if !$fields.id_autoincrement_c.hidden}
...
{/if} 
<span class="sugar_field" id="{$fields.id_autoincrement_c.name}">{$fields.id_autoincrement_c.value}</span>
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_MEANS_NOTICE' module='Opportunities'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.means_notice_c.hidden}
{counter name="panelFieldCount" print=false}

{if !empty($fields.mks_meansnotice_id_c.value)}
{capture assign="detail_url"}index.php?module=mks_MeansNotice&action=DetailView&record={$fields.mks_meansnotice_id_c.value}{/capture}
<a href="{sugar_ajax_url url=$detail_url}">{/if}
<span id="mks_meansnotice_id_c" class="sugar_field" data-id-value="{$fields.mks_meansnotice_id_c.value}">{$fields.means_notice_c.value}</span>
{if !empty($fields.mks_meansnotice_id_c.value)}</a>{/if}
{/if}
