...
<div class="buttons">
<input title="Editar" accessKey="E" name="Edit" id="edit_button" value="Editar" onclick="var _form = document.getElementById('formDetailView');_form.return_module.value='Users'; _form.return_action.value='DetailView'; _form.return_id.value='{$fields.id.value}'; _form.action.value='EditView';_form.submit();" type="button"/>
...
<input title="Restablecer Preferencias de Usuario" class="button" LANGUAGE="javascript" onclick="if(confirm('¿Está seguro de que desea restablecer todas las preferencias de este usuario?')) window.location='index.php?module=Users&action=resetPreferences&reset_preferences=true&record={$fields.id.value}';" type="button" name="password" value="Restablecer Preferencias de Usuario"/>
<input title="Restablecer Página de Inicio" class="button" LANGUAGE="javascript" onclick="if(confirm('¿Está seguro de que desea reiniciar su Página de Inicio?')) window.location='index.php?module=Users&action=DetailView&reset_homepage=true&record={$fields.id.value}';" type="button" name="password" value="Restablecer Página de Inicio"/>
...
<li><input title="Editar" accessKey="E" name="Edit" id="edit_button" value="Editar" onclick="var _form = document.getElementById('formDetailView');_form.return_module.value='Users'; _form.return_action.value='DetailView'; _form.return_id.value='{$fields.id.value}'; _form.action.value='EditView';_form.submit();" type="button"/></li>
...
<li><input title="Restablecer Preferencias de Usuario" class="button" LANGUAGE="javascript" onclick="if(confirm('¿Está seguro de que desea restablecer todas las preferencias de este usuario?')) window.location='index.php?module=Users&action=resetPreferences&reset_preferences=true&record={$fields.id.value}';" type="button" name="password" value="Restablecer Preferencias de Usuario"/></li>
<li><input title="Restablecer Página de Inicio" class="button" LANGUAGE="javascript" onclick="if(confirm('¿Está seguro de que desea reiniciar su Página de Inicio?')) window.location='index.php?module=Users&action=DetailView&reset_homepage=true&record={$fields.id.value}';" type="button" name="password" value="Restablecer Página de Inicio"/></li>
