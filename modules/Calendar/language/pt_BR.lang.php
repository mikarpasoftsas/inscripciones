...
$mod_strings = array(
    ...
    'LBL_STYLE_BASIC' => 'Básica', //Can be translated in all caps. This string will be used by SuiteP template menu actions
    'LBL_STYLE_ADVANCED' => 'Avançada', //Can be translated in all caps. This string will be used by SuiteP template menu actions
