...
$mod_strings = array(
    ...
    'help' => array(
        'package' => array(
            ...
            'savebtn' => 'Clique em <b>Salvar</b> para salvar todos os dados introduzidos, relacionados com o pacote.',
        ...
        'module' => array(
            ...
            'team_security' => 'Selecionar a caixa de selecção <b>Segurança da Equipe</b> irá habilitar a segurança de equipe para este módulo. <br/><br/>Se a segurança de equipe estiver ligada, o campo de seleção Equipe irá aparecer nos registros do módulo ',
            ...
            'audit' => 'Selecionar esta caixa irá permitir auditorias para este módulo. Alterações a certos campos serão registrados para que os administradores possam rever a história de alterações.',
            ...
            'type_issue' => 'O modelo <b>Questão</b> fornece campos específicos de ocorrências e bugs, como por exemplo Número, Estado, Prioridade e Descrição.<br/><br/>Use este modelo para criar módulos que são similares aos módulos padrão ocorrências e rastreador de bugs.',
            'type_person' => 'O tipo de modelo <b>Pessoa</b> fornece campos específicos de indivíduos, como a Saudação, Título, Nome, Endereço e Número de Telefone.<br/><br/>Usar este modelo para criar módulos que são similares aos módulos padrões de Contatos e Potenciais.',
            'type_sale' => 'O tipo de modelo <b>Venda</b> fornece campos específicos de oportunidade, como a Fonte do Potencial, Fase de Venda, Valor e Probabilidade.<br/><br/>Usar este modelo para criar módulos que são similares ao módulo padrão de Oportunidades.',
        ...
        'dropdowns' => array(
            ...
            'editdropdown' => 'Listas das Caixas de Seleção podem ser usadas em campos de caixas de seleção padrão ou personalizadas em qualquer módulo.<br/><br/>Fornecer um <b>Nome</b> para a lista da caixa de seleção.<br/><br/>Se algum pacote de idioma estiver instalado na aplicação, pode ser selecionado um <b>Idioma</b> para usar nos itens da lista.<br/><br/>No campo <b>Nome do Item</b>, forneça um nome para a opção na lista da caixa de seleção.  Este nome não irá aparecer na lista da caixa de seleção que é visível aos usuários.<br/><br/>Depois de fornecer o nome do item e o rótulo, clique em <b>Adicionar</b> para incluir o item à lista da caixa de seleção.<br/><br/>Para reordenar os itens na lista, arrastar e soltar os itens na posição desejada.<br/><br/>Para editar um rótulo de um item, clicar no <b>Ícone de Edição</b>, e inserir um novo rótulo. Para apagar um item da lista da caixa de seleção, clique no <b>Ícone de Remoção</b>.<br/><br/>Para voltar atrás na alteração feita a um rótulo, clique em <b>Desfazer</b>. Para repetir a alteração que foi desfeita, clicar <b>Refazer</b>.<br/><br/>Clique em <b>Salvar</b> para guardar a lista da caixa de seleção.',
        ...
        ,
            ...
            'Hidden' => 'Campos <b>ocultos</b> não estão atualmente disponíveis para visualização pelos usuários em ListViews.',
        ...
        'layoutEditor' => array(
            ...
            'toolbox' => 'A <b>Caixa de Ferramentas</b> contém: a <b>Lixeira</b>, os elementos de layout adicionais e o conjunto de campos disponíveis para adicionar ao layout. <br/> <br/> Os campos e elementos de layout na Caixa de Ferramentas podem ser arrastados e soltos ao layout. E, os campos e elementos de layout podem ser arrastados e soltos do layout para a Caixa de Ferramentas. <br><br>Os elementos de layout são os <b>Painéis</b> e as <b>Linhas</b>. Adicione uma nova linha ou um novo painel ao layout para disponibilizar locais adicionais no layout para os campos. <br/> <br/> Arraste e solte qualquer campo da Caixa de Ferramentas ou layout sobre a posição ocupada por outro campo para trocar os locais dos dois campos. <br/> <br/> O campo de <b>Preenchimento</b> cria um espaço em branco no layout onde é colocado.',
        ...
        'studioWizard' => array(
            'mainHelp' => 'Bem-vindo à área de <b>Ferramentas do Programador</b>. <br/><br/>Use as ferramentas desta área para criar e gerenciar módulos padrão e personalizados e campos.',
            ...
            'subpanelBtn' => 'Edite qual a informação que é exibida nos <b>Subpainéis</b> deste módulo.',
            ...
            'subpanelHelp' => 'Os <b>Subpainéis</b> no módulo que pode ser personalizado aparecem aqui. <br><br>Clique em um ícone para selecionar o módulo para editar.',
            ...
            'mbHelp' => 'Use o <b>Construtor de Módulos</b> para criar pacotes que contenham módulos personalizados baseados em objectos padrão ou personalizados.',
            ...
            'searchHelp' => 'Os formulários de <b>Filtros</b> que possam ser personalizados são exibidos aqui.<br><br>Os formulários de filtros contêm campos para filtrar os registros.<br><br>Clique num ícone para selecionar o layout de filtros a editar.',
            ...
            'BasicSearchBtn' => 'Personalizar o formulário <b>Filtro Rápido</b> que é exibido na aba Filtro Rápido na área de filtros do módulo.',
            'AdvancedSearchBtn' => 'Personalizar o formulário <b>Filtro Avançado</b> que é exibido na aba Filtro Avançado na área de filtros do módulo.',
...
<b>Excluir:</b> Excluir este módulo do layout de conversão. <br/><br/>',
        ...
        'relationshipsHelp' => array(
            ...
            'addrelbtn' => 'passe o mouse sobre a ajuda para adicionar relacionamento...',
    ...
    'assistantHelp' => array(
        ...
        'listViewEditor' => array(
            ...
            'Hidden' => 'Campos ocultos são campos que não estão atualmente disponíveis aos usuários para uso na visualização de listas.',
        ...
        'exportcustom' => array(
            ...
            'exportCustomBtn' => 'Clique em <b>Exportar</b> para criar um Arquivo .zip para o pacote contendo as personalizações do que pretende exportar.',
            ...
            'author' => 'O <b>Autor</b> é o nome de quem criou o pacote. O autor pode ser um indivíduo ou uma empresa. <br><br>O Autor será exibido no Carregador de Módulos, depois que o pacote for carregado para a instalação no Studio.',
        ...
        'studioWizard' => array(
            'mainHelp' => 'Bem-vindo à área de <b>Ferramentas do Desenvolvedor</b>. <br/><br/> Use as ferramentas desta área para criar e gerenciar campos e módulos padrões e personalizados.',
...
//STUDIO2
    ...
    'LBL_TABDEF_TYPE_OPTION_HELP' => 'Selecione Painel para ter este painel exibido dentro da exibição do layout. Selecione Guia para ter este painel exibido dentro de uma guia separada do layout. Quando é especificado Guia para um painel, painéis subsequentes definidos para serem exibidos como Painel serão exibidos dentro da guia. <br/>Uma nova Guia será iniciada para o próximo painel, onde foi selecionado Guia. Se Guia está selecionada para um painel abaixo do primeiro painel, o primeiro painel será necessariamente uma Guia.',
    ...
    'LBL_NO_SAVE_ACTION' => 'Não foi possível encontrar a ação de salvar para esta vista.',
...
//STUDIO QUESTIONS
    ...
    'LBL_QUESTION_SEARCH' => 'Selecione um layout de filtro para editar.',
...
//EXPORT CUSTOMS
    ...
    'LBL_EC_VIEWS' => 'visualização(s) personalizada(s)',
    'LBL_EC_SUGARFEEDS' => 'feed(s) personalizado(s)',
    'LBL_EC_DASHLETS' => 'Dashlet(s) Personalizado(s)',
    'LBL_EC_CSS' => 'CSS(s) Personalizado(s)',
    'LBL_EC_TPLS' => 'tpls(s) personalizados',
    'LBL_EC_IMAGES' => 'imagem(ns) personalizadas',
...
//Revert Module labels
    ...
    'labelTypes' => array(
        "frequently_used" => "Rótulos usados frequentemente",
        "all" => "Todos os rótulos",
    ),

    'parent' => 'Flex Relacionar',

    'LBL_CONFIRM_SAVE_DROPDOWN' => "Você está selecionando este item para remoção dessa lista dropdown. Quaisquer campos que utilizem essa lista dropdown com esse valor selecionado, vão deixar de exibi-lo, e este item não ficará mais disponível para seleção em nenhum desse campos. Tem certeza que deseja continuar?",
