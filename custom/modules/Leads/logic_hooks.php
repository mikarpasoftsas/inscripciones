...
$hook_array['before_save'][] = Array(2, 'set_autoincrement', 'custom/modules/Leads/set_autoincrement_le.php','set_autoincrement_le', 'set_autoincrement_le'); 
...
$hook_array['after_save'][] = Array(77, 'convertLeadIntoAccount', 'custom/modules/Leads/ConvertLeadIntoAccountLogicHook.php','ConvertLeadIntoAccountLogicHook', 'ConvertLeadIntoAccountLogicHook'); 
