...
class QuickSearchDefaultsCustom
{
    ...
    function getQSUser($p_name = 'assigned_user_name', $p_id ='assigned_user_id') {
        ...
        $qsUser = array('form' => $this->form_name,
                        ...
                        'conditions' => array(array('name'=>'user_name','op'=>'like_custom','end'=>'','value'=>$current_user->user_name)),
                        'limit' => '1','no_match_text' => $app_strings['ERR_SQS_NO_MATCH']);
        return $qsUser;
    }
