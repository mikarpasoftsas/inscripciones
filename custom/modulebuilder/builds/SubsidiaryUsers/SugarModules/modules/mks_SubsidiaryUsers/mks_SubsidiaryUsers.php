...
class mks_SubsidiaryUsers extends Person
{
    public $new_schema = true;
    public $module_dir = 'mks_SubsidiaryUsers';
    public $object_name = 'mks_SubsidiaryUsers';
    public $table_name = 'mks_subsidiaryusers';
