...
git config git-ftp.production.user ftp://162.241.139.215/
git config git-ftp.production.url repository@logos.igi-la.com
git config git-ftp.production.password R3posiTor1
